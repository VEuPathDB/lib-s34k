...
---
//[s34k](../../../index.html)/[org.veupathdb.lib.s3.s34k.errors](../index.html)/[InvalidRequestConfigException](index.html)
...
[jvm]\
class [InvalidRequestConfigException](index.html) : [S34kException](../-s34k-exception/index.html)

Exception thrown due to an invalid request/operation configuration.



Generally this is due to a required field, such as bucketName or path not being set on the operation config.
...
| | |
|---|---|
| [InvalidRequestConfigException](-invalid-request-config-exception.html) | [jvm]<br>fun [InvalidRequestConfigException](-invalid-request-config-exception.html)(reason: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), params: [S3RequestParams](../../org.veupathdb.lib.s3.s34k.requests/-s3-request-params/index.html)) |
| [InvalidRequestConfigException](-invalid-request-config-exception.html) | [jvm]<br>fun [InvalidRequestConfigException](-invalid-request-config-exception.html)(reason: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), params: [S3RequestParams](../../org.veupathdb.lib.s3.s34k.requests/-s3-request-params/index.html), cause: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)) |
| [InvalidRequestConfigException](-invalid-request-config-exception.html) | [jvm]<br>fun [InvalidRequestConfigException](-invalid-request-config-exception.html)(reason: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), params: [S3RequestParams](../../org.veupathdb.lib.s3.s34k.requests/-s3-request-params/index.html), message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) |
| [InvalidRequestConfigException](-invalid-request-config-exception.html) | [jvm]<br>fun [InvalidRequestConfigException](-invalid-request-config-exception.html)(reason: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), params: [S3RequestParams](../../org.veupathdb.lib.s3.s34k.requests/-s3-request-params/index.html), message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), cause: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)) |
...
| [params](params.html) | [jvm]<br>val [params](params.html): [S3RequestParams](../../org.veupathdb.lib.s3.s34k.requests/-s3-request-params/index.html) |
| [reason](reason.html) | [jvm]<br>val [reason](reason.html): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html) |
