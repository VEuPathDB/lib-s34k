...
---
//[s34k](../../../index.html)/[org.veupathdb.lib.s3.s34k.errors](../index.html)/[BucketNotEmptyException](index.html)
...
[jvm]\
class [BucketNotEmptyException](index.html) : [AbstractBucketOperationException](../-abstract-bucket-operation-exception/index.html)
...
| | |
|---|---|
| [BucketNotEmptyException](-bucket-not-empty-exception.html) | [jvm]<br>fun [BucketNotEmptyException](-bucket-not-empty-exception.html)(bucket: [BucketName](../../org.veupathdb.lib.s3.s34k.fields/-bucket-name/index.html), msg: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) |
| [BucketNotEmptyException](-bucket-not-empty-exception.html) | [jvm]<br>fun [BucketNotEmptyException](-bucket-not-empty-exception.html)(bucket: [BucketName](../../org.veupathdb.lib.s3.s34k.fields/-bucket-name/index.html), msg: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), cause: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)) |
| [BucketNotEmptyException](-bucket-not-empty-exception.html) | [jvm]<br>fun [BucketNotEmptyException](-bucket-not-empty-exception.html)(bucket: [BucketName](../../org.veupathdb.lib.s3.s34k.fields/-bucket-name/index.html), cause: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)) |
| [BucketNotEmptyException](-bucket-not-empty-exception.html) | [jvm]<br>fun [BucketNotEmptyException](-bucket-not-empty-exception.html)(bucket: [BucketName](../../org.veupathdb.lib.s3.s34k.fields/-bucket-name/index.html)) |
