---
title: S3BucketTagCreateParams
---
//[s34k](../../../index.html)/[org.veupathdb.lib.s3.s34k.requests.bucket](../index.html)/[S3BucketTagCreateParams](index.html)



# S3BucketTagCreateParams



[jvm]\
interface [S3BucketTagCreateParams](index.html) : [S3TagCreateParams](../../org.veupathdb.lib.s3.s34k.requests/-s3-tag-create-params/index.html)
...
| Name | Summary |
|---|---|
| [callback](callback.html) | [jvm]<br>abstract var [callback](callback.html): () -&gt; [Unit](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)?<br>Optional callback that will be executed on successful completion of the S3 operation. |
