...
internal abstract class ArrayMap : Iterable<Pair<String, List<String>>> {
  ...
  internal inline fun mergeMap(key: String, new: Array<out String>) {
  ...
  internal inline fun copyArray(array: Array<out String>): Array<String> {
  ...
  @Suppress("UNCHECKED_CAST")
  internal inline fun mergeArrays(
    old: Array<String>,
