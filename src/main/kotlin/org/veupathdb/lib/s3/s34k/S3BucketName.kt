 ...
 *
 * @constructor Tests the input string and creates a new [S3BucketName] instance.
 *
 ...
 */
@JvmInline
value class S3BucketName(val name: String) {
  ...
  companion object {
    ...
    /**
     * Constructs a new [S3BucketName] instance from the given name if it is not
     * `null`.
     *
     ...
     *
     * @return New [S3BucketName] instance.
     *
     ...
     */
    @JvmStatic
    fun of(name: String?): S3BucketName {
      if (name == null)
